...
import { getOverduePayment, getUpcomingPayments } from '../../../network/managers/collectionsAPI'
...
const UpcomingPayments = ({ navigation, route }: Props) => {
    ...
    const getPaymentData = async () => {
        ...
        const resp = await getUpcomingPayments({ page: refPagenumber.current, search: refSearchString.current })

        console.log('==================================== resp COLLECTIONS_UPCOMING');
        console.log(resp);
        console.log('====================================');
        if (resp.status == true) {
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                data={info.data}
                renderItem={({ item, index }) => <ItemUpcomingPayment style={styles.styleItem} item={item} onPress={onPressItem} sty />}
                // refreshControl={
