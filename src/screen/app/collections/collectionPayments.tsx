...
import { getCollectionPayments, getOverduePayment } from '../../../network/managers/collectionsAPI'
...
const CollectionPayments = ({ navigation, route }: Props) => {
    ...
    const getPaymentData = async () => {
        ...
        const resp = await getCollectionPayments({ page: refPagenumber.current, search: refSearchString.current })
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                data={info.data}
                renderItem={({ item, index }) => <ItemPaymentCollection style={styles.styleItem} item={item} onPress={onPressItem} sty />}
                // refreshControl={
